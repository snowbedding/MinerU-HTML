"""
Logits processor v1 for structured output generation.
...
This is the v1 version without Think logic.
"""
...
class TokenStateMachine:
    ...
    def handle_begin(
        ...
        Starts JSON generation. If max_count is 0, generates empty object.
        Otherwise, starts with opening brace and transitions to Decide_Main_Other.
